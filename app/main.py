...
async def fix_database():
    ...
    statements = [
        ...
        "ALTER TABLE brands ADD COLUMN IF NOT EXISTS template_id VARCHAR(100)",
        ...
        "ALTER TABLE categories ADD COLUMN IF NOT EXISTS caption_prompt_template TEXT",
        ...
        "ALTER TABLE categories ADD COLUMN IF NOT EXISTS custom_rss_feeds TEXT",
        "ALTER TABLE categories ADD COLUMN IF NOT EXISTS custom_google_news_query TEXT",
        ...
        "ALTER TABLE trends ADD COLUMN IF NOT EXISTS scraped_at TIMESTAMP DEFAULT NOW()",
        ...
        "ALTER TABLE studio_projects ADD COLUMN IF NOT EXISTS video_duration INTEGER",
        ...
        "ALTER TABLE studio_projects ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT NOW()",
        "ALTER TABLE studio_projects ADD COLUMN IF NOT EXISTS completed_at TIMESTAMP",
        
        # ========== SCHEDULED_SOCIAL_POSTS TABLE ==========
        "ALTER TABLE scheduled_social_posts ADD COLUMN IF NOT EXISTS user_id INTEGER",
        "ALTER TABLE scheduled_social_posts ADD COLUMN IF NOT EXISTS brand_id INTEGER",
        "ALTER TABLE scheduled_social_posts ADD COLUMN IF NOT EXISTS content_id INTEGER",
        "ALTER TABLE scheduled_social_posts ADD COLUMN IF NOT EXISTS social_account_id INTEGER",
        "ALTER TABLE scheduled_social_posts ADD COLUMN IF NOT EXISTS scheduled_time TIMESTAMP",
        "ALTER TABLE scheduled_social_posts ADD COLUMN IF NOT EXISTS platform VARCHAR(50)",
        ...
        "ALTER TABLE scheduled_social_posts ADD COLUMN IF NOT EXISTS posted_at TIMESTAMP",
        "ALTER TABLE scheduled_social_posts ADD COLUMN IF NOT EXISTS post_url TEXT",
        "ALTER TABLE scheduled_social_posts ADD COLUMN IF NOT EXISTS post_id VARCHAR(255)",
        ...
        "ALTER TABLE social_accounts ADD COLUMN IF NOT EXISTS user_id INTEGER",
        ...
        "ALTER TABLE social_accounts ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT NOW()",
        ...
        "ALTER TABLE videos ADD COLUMN IF NOT EXISTS brand_id INTEGER",
        "ALTER TABLE videos ADD COLUMN IF NOT EXISTS name VARCHAR(255)",
        ...
        "ALTER TABLE videos ADD COLUMN IF NOT EXISTS resolution VARCHAR(20)",
        "ALTER TABLE videos ADD COLUMN IF NOT EXISTS aspect_ratio VARCHAR(20)",
        "ALTER TABLE videos ADD COLUMN IF NOT EXISTS status VARCHAR(50) DEFAULT 'pending'",
        "ALTER TABLE videos ADD COLUMN IF NOT EXISTS progress_percent INTEGER DEFAULT 0",
        ...
        "ALTER TABLE videos ADD COLUMN IF NOT EXISTS generation_cost_usd FLOAT",
        "ALTER TABLE videos ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT NOW()",
        "ALTER TABLE videos ADD COLUMN IF NOT EXISTS completed_at TIMESTAMP",
        
        # ========== AB_TESTS TABLE ==========
        "ALTER TABLE ab_tests ADD COLUMN IF NOT EXISTS user_id INTEGER",
        "ALTER TABLE ab_tests ADD COLUMN IF NOT EXISTS brand_id INTEGER",
        "ALTER TABLE ab_tests ADD COLUMN IF NOT EXISTS name VARCHAR(255)",
        "ALTER TABLE ab_tests ADD COLUMN IF NOT EXISTS description TEXT",
        ...
        "ALTER TABLE ab_test_variants ADD COLUMN IF NOT EXISTS ab_test_id INTEGER",
        "ALTER TABLE ab_test_variants ADD COLUMN IF NOT EXISTS name VARCHAR(255)",
        "ALTER TABLE ab_test_variants ADD COLUMN IF NOT EXISTS content_id INTEGER",
        "ALTER TABLE ab_test_variants ADD COLUMN IF NOT EXISTS impressions INTEGER DEFAULT 0",
        "ALTER TABLE ab_test_variants ADD COLUMN IF NOT EXISTS clicks INTEGER DEFAULT 0",
        "ALTER TABLE ab_test_variants ADD COLUMN IF NOT EXISTS conversions INTEGER DEFAULT 0",
        "ALTER TABLE ab_test_variants ADD COLUMN IF NOT EXISTS engagement_rate FLOAT",
        "ALTER TABLE ab_test_variants ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT NOW()",
        ...
        "ALTER TABLE usage_records ADD COLUMN IF NOT EXISTS record_type VARCHAR(50)",
        "ALTER TABLE usage_records ADD COLUMN IF NOT EXISTS quantity INTEGER DEFAULT 1",
        "ALTER TABLE usage_records ADD COLUMN IF NOT EXISTS cost_usd FLOAT",
        ...
        # ========== BRAND_VOICE ==========
        "ALTER TABLE brand_voices ADD COLUMN IF NOT EXISTS user_id INTEGER",
        "ALTER TABLE brand_voices ADD COLUMN IF NOT EXISTS brand_id INTEGER",
        "ALTER TABLE brand_voices ADD COLUMN IF NOT EXISTS name VARCHAR(255)",
        ...
        "ALTER TABLE brand_voices ADD COLUMN IF NOT EXISTS style TEXT",
        "ALTER TABLE brand_voices ADD COLUMN IF NOT EXISTS vocabulary TEXT",
        "ALTER TABLE brand_voices ADD COLUMN IF NOT EXISTS examples TEXT",
        "ALTER TABLE brand_voices ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT TRUE",
        "ALTER TABLE brand_voices ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT NOW()",
        "ALTER TABLE brand_voices ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT NOW()",
        
        # ========== SEED CATEGORIES ==========
        "INSERT INTO categories (name, description) VALUES ('Fashion', 'Fashion and style content') ON CONFLICT DO NOTHING",
        ...
        "INSERT INTO categories (name, description) VALUES ('Travel', 'Travel and adventure') ON CONFLICT DO NOTHING",
        ...
        "INSERT INTO categories (name, description) VALUES ('Beauty', 'Beauty and cosmetics') ON CONFLICT DO NOTHING",
        "INSERT INTO categories (name, description) VALUES ('Business', 'Business and entrepreneurship') ON CONFLICT DO NOTHING",
    ]
        ...
        with engine.connect() as conn:
            for sql in statements:
                try:
                    ...
                    results["success"].append(sql[:60])
                except Exception as e:
                    error_msg = str(e)
                    if "already exists" in error_msg.lower() or "duplicate" in error_msg.lower():
                        results["skipped"].append(sql[:60])
                    else:
                        results["errors"].append({"sql": sql[:60], "error": error_msg[:100]})
            conn.commit()
